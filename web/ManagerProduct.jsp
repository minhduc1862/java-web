    ...
    <body>
        <div class="container">
            <div class="table-wrapper">
                        ...
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete?pid=${o.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i>
                ...
                <div class="clearfix">
                    <div class="hint-text"> <a href="home"><button type="button" class="btn btn-primary">Trở về</button></div>
                    <ul class="pagination">
                ...
                <div class="modal-content">
                    <form action="add" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <input name="gta" type="submit" class="btn btn-success" value="Add">
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <form>
                        <div class="modal-header">						
                            ...
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&10000000;</button>
                        </div>
                        <div class="modal-body">					
                            <p>Bạn có chắc chắn muốn xóa sản phẩm này</p>
                            <p class="text-warning"><small>Không thể xóa.</small></p>
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
