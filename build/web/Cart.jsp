                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${list}" var="o">
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><strong><fmt:setLocale value = "vi_VN"/>
                                                                                     <fmt:formatNumber value = "${o.price}" type = "currency"/></strong></td>
                                                    <td class="align-middle">
                                                        <a href="Sub?id=${o.id}"><button class="btnSub" type="button">-</button></a> 
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    </ul><a href="#editEmployeeModal" class="btn btn-dark rounded-pill py-2 btn-block" data-toggle="modal">Mua hàng</a>
                                </div>
                            </div>
                        </div>
